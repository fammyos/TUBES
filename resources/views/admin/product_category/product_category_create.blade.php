...
<section class="section">
    <div class="row">
        ...
        <div class="card">
            ...
            <form action="{{route('product.category.store')}}" method="POST" novalidate>
                {{ csrf_field() }}
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Category</label>
                  <div class="col-sm-10">
                    <input type="text" name="category" class="form-control" value="{{old('category')}}" autocomplete="category" placeholder="category" required>
                  </div>
                </div>
                <div class="row mb-3">
